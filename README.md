...
> **Данные:** в режиме **Google Таблиц** оба канала работают с одной и той же
> вашей таблицей (данные общие). В режиме **Локально (IndexedDB)** у каждого
> канала своё хранилище (разный scope PWA) — данные не пересекаются.
