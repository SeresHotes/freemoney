...
export default function Debt() {
  ...
  const submit = async (e) => {
    e.preventDefault();
    setFormError(null);
    if (!workWallet) { setFormError('Выберите кошелёк'); return; }
    ...
    <div className="page">
      ...
      <form className="form" onSubmit={submit}>
        ...
        <label className="field">
          ...
          <select className="field__input field__input--select" value={workWallet} onChange={(e) => setWorkWallet(e.target.value)}>
